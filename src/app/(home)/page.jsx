...
import RegisterModal from "@/components/registerationModal/RegisterModal";
import SuccessModal from "@/components/registerationModal/SuccessModal";
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="font-satoshi flex flex-col relative">
          ...
          <div className="flex flex-col justify-center items-center h-full text-white relative z-10">
            ...
            <div className="flex flex-col justify-center items-center md:mt-30 mt-28 text-center">
              ...
              <p className="xl:lg:w-[45%] lg:w-[75%] text-base md:text-[24px] mt-6 w-[90%] leading-[30px] md:leading-[40px]">
                Pitch your idea to win an all-expenses paid
                trip to the largest tech and startup event
                in Africa – GITEX AFRICA 2024, Marrakech,
                Morocco
              </p>
            </div>
        ...
        <section
          ...
          className="md:px-24 py-12 px-6 "
        >
          <div className="flex justify-center">
            <p className="text-center md:text-[24px] xl:lg:w-[60%] lg:w-[95%]">
              Are you ready to catapult your startup onto
              the global stage? Gitex and Wema Bank invites
              you on an adventure to unlock an extraordinary
              opportunity that could transform your
              ...
              <div className="flex md:flex-row flex-col gap-y-20 justify-between gap-x-6">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col md:text-start text-center">
                    ...
                    <p className="lg:w-[350px] md:text-[22px]">
                      Compete against the best and brightest
                      startups from diverse industries.
                      Showcase your unique value proposition
                      to a panel of seasoned investors and
                      industry experts for a chance to
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col md:text-start text-center">
                    ...
                    <p className="lg:w-[350px] md:text-[22px]">
                      Forge meaningful connections with
                      global ecosystem players, potential
                      partners, mentors, and investors.
                      Expand your network and gain insights
                      from leaders shaping the future of
              ...
              <div className="flex md:flex-row flex-col gap-y-20 justify-between gap-x-6">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col md:text-start text-center">
                    ...
                    <p className="lg:w-[350px] md:text-[22px]">
                      Gain unparalleled exposure for your
                      startup on aglobal scale. Showcase
                      your product or service to a diverse
                      audience of investors, media, and
                      industry influencers, amplifying your
                      brand&apos;s visibility and reach.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col  md:text-start text-center">
                    ...
                    <p className="lg:w-[350px] md:text-[22px]">
                      Benefit from exclusive workshops,
                      mentorship sessions, and resources
                      designed to support your
                      startup&apos;s growth journey. Tap
                      into the knowledge and expertise of
                      seasoned professionals to overcome
                      challenges and accelerate your
                      success.
                    </p>
                  </div>
                </div>
